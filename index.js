...
// Esta es la función que Google está buscando
exports.retirexapi = (req, res) => {
  return cors(req, res, async () => {
    // Respuesta para el Health Check de Google
    if (req.method === 'GET' && req.path === '/') {
      return res.status(200).send("Retirex Engine Ready ✅");
    }
    ...
    if (path === '/cotizar') {
      ...
      } catch (e) { return res.status(500).send("Error en cálculo"); }
    }
